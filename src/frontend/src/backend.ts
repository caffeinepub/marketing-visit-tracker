...
export class Backend implements backendInterface {
    ...
    async createVisit(arg0: string, arg1: string, arg2: string, arg3: number, arg4: number, arg5: Time, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createVisit(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyVisits(): Promise<Array<Visit>> {
        if (this.processError) {
            try {
    ...
    async getVisitsByUser(arg0: Principal): Promise<Array<Visit>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVisitsByUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
